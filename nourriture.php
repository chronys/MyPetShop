...
* {
  ...
  <?php   
  $donnee = $pdo -> query("SELECT * FROM produits WHERE categorie = 'alimentation'");
  ...
  <div class="monh2">
    <h2>Assurez une bonne santé à votre compagnon</h2>
  </div>
  ...
  foreach ($donnees as $value) { ?>
    ...
    <div class="produit">
      <img src="../assets/img/imgalimentation/<?php echo $value['image_produit']?>" alt="<?php echo $value['nom_produit']?>">
