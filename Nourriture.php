...
<body>
  ...
  $produits = [
    [
      "nom"   => "Croquettes premium toutes étapes de vie",
      "image" => "img/imgalimentation/A1.png",
      "prix"  => 29.99
    ],

    [
      "nom"   => "Pâtée complète (multi-âge)",
      "image" => "img/imgalimentation/A2.png",
      "prix"  => 19.99
    ],

    [
      "nom"   => "Friandises naturelles déshydratées",
      "image" => "img/imgalimentation/A3.png",
      "prix"  => 9.99
    ],

    [
      "nom"   => "Bâtonnets dentaires souples",
      "image" => "img/imgalimentation/A4.png",
      "prix"  => 16.50
    ],

    [
      "nom"   => "Mousse à lécher",
      "image" => "img/imgalimentation/A5.png",
      "prix"  => 4.99
    ],

    [
      "nom"   => "Compléments naturels",
      "image" => "img/imgalimentation/A6.png",
      "prix"  => 25
    ]
  ];
  ?>

  <h1>Nourriture pour chiens</h1>
  <div class="monh2">
    <h2>Assurez une bonne santé à votre compagnon <img width="80" height="80" src="https://img.icons8.com/dotty/80/dog.png" alt="dog" /></h2>
  </div>
