...
* {
  ...
  $donnee = $pdo -> query("SELECT * FROM produits WHERE categorie = 'jouets'");
  ...
  <div class="monh2">
    <h2>Assurez du bonheur à votre compagnon</h2>
  </div>
  ...
  foreach ($donnees as $value) { ?>
    ...
    <div class="produit">
      <img src="../assets/img/imgjouets/<?php echo $value['image_produit']?>" alt="<?php echo $value['nom_produit']?>">
