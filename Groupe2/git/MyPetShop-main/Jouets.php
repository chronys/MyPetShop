...
<body>
  ...
  $produits = [
    [
      "nom"   => "Kong à remplir",
      "image" => "img/imgjouets/J1.png",
      "prix"  => 6.99
    ],

    [
      "nom"   => "Balle souple ou texturée",
      "image" => "img/imgjouets/J2.png",
      "prix"  => 9.99
    ],

    [
      "nom"   => "Jouet en corde (tug)",
      "image" => "img/imgjouets/J3.png",
      "prix"  => 15.99
    ],

    [
      "nom"   => "Peluches renforcées avec pouic",
      "image" => "img/imgjouets/J4.png",
      "prix"  => 24.50
    ],

    [
      "nom"   => "Tapis de fouille (snuffle mat)",
      "image" => "img/imgjouets/J5.png",
      "prix"  => 24.99
    ],

    [
      "nom"   => "Jouet distributeur de friandises",
      "image" => "img/imgjouets/J6.png",
      "prix"  => 6.99
    ]
  ];
  ?>
  ...
  <div class="monh2">
    <h2>Assurez du bonheur à votre compagnon <img width="80" height="80" src="https://img.icons8.com/dotty/80/dog.png" alt="dog" /></h2>
  </div>
